...
enum tpm2_rsp {
	TPM2_RSP_SUCCESS= 0,
	TPM2_RSP_BAD_TAG = 0x1E,

	TPM2_RSP_FMT1 = 0x80,
	TPM2_RSP_HASH = TPM2_RSP_FMT1 + 3,
	TPM2_RSP_VALUE = TPM2_RSP_FMT1 + 4,
	TPM2_RSP_HANDLE = TPM2_RSP_FMT1 + 0xB,
	TPM2_RSP_SIZE = TPM2_RSP_FMT1 + 0x15,
	TPM2_RSP_BAD_AUTH = TPM2_RSP_FMT1 + 0x22,

	TPM2_RSP_VER1 = 0x100,
	TPM2_RSP_INITIALIZE = TPM2_RSP_VER1,
	TPM2_RSP_FAILURE = TPM2_RSP_VER1 + 1,
	TPM2_RSP_DISABLED = TPM2_RSP_VER1 + 0x20,
	TPM2_RSP_AUTH_MISSING = TPM2_RSP_VER1 + 0x25,
	TPM2_RSP_COMMAND_CODE = TPM2_RSP_VER1 + 0x43,
	TPM2_RSP_AUTHSIZE = TPM2_RSP_VER1 + 0x44,
	TPM2_RSP_AUTH_CONTEXT = TPM2_RSP_VER1 + 0x45,
	TPM2_RSP_NV_DEFINED = TPM2_RSP_VER1 + 0x4c,
	TPM2_RSP_NEEDS_TEST = TPM2_RSP_VER1 + 0x53,

	TPM2_RSP_WARN = 0x900,
	TPM2_RSP_TESTING = TPM2_RSP_WARN + 0xA,
	TPM2_RSP_REFERENCE_H0 = TPM2_RSP_WARN + 0x10,
	TPM2_RSP_LOCKOUT = TPM2_RSP_WARN + 0x21,
};
