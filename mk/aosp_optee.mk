...
$(TA_TMP_FILE): $(OPTEE_BIN)
	@echo "PLATFORM_VERSION yowza [${PLATFORM_VERSION}])"
	@echo "PRODUCT_SHIPPING_API_LEVEL yowza [${PRODUCT_SHIPPING_API_LEVEL}])"
	@echo "API_LEVEL yowza [${API_LEVEL}])"
	@echo "LOCAL_SDK_VERSION yowza [${LOCAL_SDK_VERSION}])"
